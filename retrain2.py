...
model.fit_generator(train_batches, steps_per_epoch=18,
                    validation_data=valid_batches, validation_steps=3, epochs=100, verbose=2)
...
cm_plot_labels = ['Analyn','Arlene','Franz Clint', 'Genie', 'Jeffrey', 'Jefranc', 'Jennifer', 'Joevert', 'John Arjay', 
                    'Kristine', 'Mardon', 'Marddon', 'Nino', 'Norman', 'Reynaldo', 'Ruel James', 'Sherwin']
